...
const Featured = () => {
    return (
        <div className='featured mt-8 p-2 sm:p-0'>
            <h1 className='title text-2xl lg:text-4xl'>
                <strong>Hey, Chandu here!</strong> Discover my stories and creative ideas.
            </h1>
            <div className='post  mt-5 sm:mt-8 sm:flex gap-5 lg:gap-10 justify-between w-full'>
                ...
                <div className="textContainer mt-2 sm:mt-0 relative flex flex-1 flex-col text-justify gap-4 overflow-hidden lg:gap-6">
                    <h1 className='postTitle text-xl font-bold lg:text-3xl'>Lorem, ipsum dolor sit amet consectetur adipisicing elit amet sit.</h1>
                    ...
                    <button className='btn px-2 py-1 border-none rounded-lg w-max bg-sky-200 text-black'>Read More</button>
                </div>
            </div>
        </div>
